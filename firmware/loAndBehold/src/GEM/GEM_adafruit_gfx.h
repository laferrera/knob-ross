...
#include "fonts/font04B_03_4pt.h"
#include "GEMPage.h"
#include "GEMSelect.h"
#include "constants.h"
...
#define GEM_FONT_CUSTOM    &font04B4pt7b
...
class GEM_adafruit_gfx {
  public:
    ...
    */
    ...
    const char *getMenuPageCurrent();                    // Get supplied menu page as current
  ...
  private:
    ...
    // {width, height, baselineOffset} Baseline position relative to the top edge of the character box
    // first array is mostly used.... 
    // FontSizeAgfx _menuItemFont[2] = {{4, 8, 6}, {3, 6, 6}}; // this one works pretty good...
    FontSizeAgfx _menuItemFont[2] = {{4, 8, 6}, {3, 6, 6}}; 
